...
import com.example.upick.login.security.filter.FormLoginFilter;
import com.example.upick.login.security.filter.JwtAuthFilter;
import com.example.upick.login.security.jwt.HeaderTokenExtractor;
import com.example.upick.login.security.provider.FormLoginAuthProvider;
import com.example.upick.login.security.provider.JWTAuthProvider;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) {
        ...
        web
                .ignoring()
                .antMatchers("/h2-console/**" ,"/swagger-ui.html/**","/swagger-resources/**"
                ,"/webjars/**","/swagger/**","/v2/**");
    }
